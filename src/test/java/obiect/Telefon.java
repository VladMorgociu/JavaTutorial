...
public class Telefon {
    ...
    public Telefon(String marca, String model, String culoare, String memorie, Integer pret,
                   Map<String, String> specificatiiTehnice, List<String> accesoriiIncluse, Boolean produsResigilat, String observatii) {
        this.marca = marca;
        this.model = model;
    ...
    public  void infoTelefon (){
        ...
        System.out.println("Pretul telefonului este de " + pret + " lei.");

        System.out.println("Specificatiile telefonului sunt urmatoarele: " + specificatiiTehnice);
        for (String key: specificatiiTehnice.keySet()){
            System.out.println(key + " " + specificatiiTehnice.get(key));


        System.out.println("Accesoriile din cutie sunt: " + accesoriiIncluse);
